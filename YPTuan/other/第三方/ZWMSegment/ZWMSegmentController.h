...
/// initial
+ (__nullable instancetype)segmentControllerWithTitles:(NSArray <NSString *>*)titles isDynamic:(BOOL)isDynamic;
- (__nullable instancetype)initWithFrame:(CGRect)frame titles:(NSArray *)titles isDynamic:(BOOL)isDynamic;
