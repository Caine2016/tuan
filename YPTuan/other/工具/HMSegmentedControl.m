...
//            CGFloat stringWidth = roundf([titleString sizeWithFont:self.font].width);
            ...
            CGFloat stringHeight = roundf([XTools getWidthByString:titleString withFont:self.font withStringSize:CGSizeMake(1000, 2000)].height);
            CGFloat stringWidth = roundf([XTools getWidthByString:titleString withFont:self.font withStringSize:CGSizeMake(1000, 2000)].width);
		...
		[self.sectionImages enumerateObjectsUsingBlock:^(id iconImage, NSUInteger idx, BOOL *stop) {
			...
			//CGFloat stringHeight = roundf([self.sectionTitles[idx] sizeWithFont:self.font].height);
              CGFloat stringHeight = roundf([XTools getWidthByString:self.sectionTitles[idx] withFont:self.font withStringSize:CGSizeMake(1000, 2000)].height);
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.type == HMSegmentedControlTypeText) {
       ...
       // CGFloat stringWidth = [[self.sectionTitles objectAtIndex:self.selectedSegmentIndex] sizeWithFont:self.font].width;
         ...
         CGFloat stringWidth = roundf([XTools getWidthByString:[self.sectionTitles objectAtIndex:self.selectedSegmentIndex] withFont:self.font withStringSize:CGSizeMake(1000, 2000)].width);
