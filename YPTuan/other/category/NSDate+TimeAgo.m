...
- (NSString *)timeAgo
{
    ...
    {
        return [self stringFromFormat:@"%%d %@秒之前" withValue:deltaSeconds];
    }
    ...
    {
        return [self stringFromFormat:@"%%d %@分钟之前" withValue:deltaMinutes];
    }
    ...
    else if (deltaMinutes < (24 * 60))
    {
        ...
        return [self stringFromFormat:@"%%d %@小时之前" withValue:minutes];
    }
